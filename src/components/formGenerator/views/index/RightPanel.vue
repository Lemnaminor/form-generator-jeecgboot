    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <!-- 分隔符 -->
          <template v-if="activeData.__config__.tag === 'el-divider'">
            <el-form-item
              label="分隔符文字"
            >
              <el-input v-model="activeData.__slot__.default" placeholder="请输入分隔符文字" />
            </el-form-item>
            <el-form-item label="分隔符方向">
          ...
          <!-- 文本 -->
          <template v-if="activeData.__config__.tag === 'j-text'">
            <el-form-item label="行高">
              <el-input-number v-model="activeData['line-height']" :min="0" :max="10" />
            </el-form-item>
            ...
            <el-form-item label="字体大小">
              <el-input-number v-model="activeData['font-size']" :min="12" :max="100" /> px
            </el-form-item>
            <el-form-item label="字体颜色">
              <div style="display: flex;align-item:center;">
                <el-input v-model="activeData.color" style="width: 100px;margin-right:10px;" />
                <el-color-picker v-model="activeData.color" />
              </div>
            </el-form-item>
            <el-form-item label="字体样式">
              <!-- <el-checkbox-group> -->
              <el-checkbox v-model="activeData['font-weight']" label="加粗" />
              <el-checkbox v-model="activeData['font-style']" label="斜体" />
              <el-checkbox v-model="activeData['font-decoration']" label="下划线" />
              <!-- </el-checkbox-group> -->
            </el-form-item>
          </template>

          <!-- 部门组件 -->
          <template v-if="activeData.__config__.tag === 'j-select-dept'">
            <el-form-item label="部门名">
              <el-input :value="activeData.__config__.defaultValue | hiddenId" readonly @focus="$refs.DeptDialog.dialogVisible = true" />
              <dept-dialog ref="DeptDialog" :multi="activeData.multi" @onSelect="(obj) => {activeData.__config__.defaultValue = (obj.names && obj.ids) ? `${obj.names}_*_${obj.ids}` : ''}" />
            </el-form-item>
            <el-form-item label="允许多选">
              <el-switch
                v-model="activeData.multi"
              />
            </el-form-item>
          </template>

          <!-- 用户组件 -->
          <template v-if="activeData.__config__.tag === 'j-select-user'">
            <el-form-item label="用户名">
              <el-input :value="activeData.__config__.defaultValue | hiddenId" readonly @focus="$refs.UserDialog.dialogVisible = true" />
              <user-dialog ref="UserDialog" :multi="activeData.multi" @onSelect="(obj) => {activeData.__config__.defaultValue = (obj.names && obj.ids) ? `${obj.names}_*_${obj.ids}` : ''}" />
            </el-form-item>
            <el-form-item label="允许多选">
              <el-switch
                v-model="activeData.multi"
          ...
          <el-form-item v-if="activeData.__config__.tag === 'el-input' || activeData.__config__.tag === 'j-select-user' || activeData.__config__.tag === 'j-select-dept'" label="隐藏字段"
          >
            <el-switch v-model="activeData.__config__.hideField" />
          </el-form-item>
...
import TreeNodeDialog from '@/components/formGenerator/views/index/TreeNodeDialog'
...
import DeptDialog from '@/components/formGenerator/components/JComp/JSelectDept/DeptDialog'
import UserDialog from '@/components/formGenerator/components/JComp/JSelectUser/UserDialog'
